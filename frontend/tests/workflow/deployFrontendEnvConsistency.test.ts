...
describe('E19-01: frontend env consistency', () => {
  it('docs が VITE_API_BASE_URL を使用し旧キーを含まない', () => {
    ...
    expect.soft(frontendReadme).not.toContain('REACT_APP_API_URL')
    expect.soft(frontendReadme).not.toContain('REACT_APP_GA_MEASUREMENT_ID')
  })
})
