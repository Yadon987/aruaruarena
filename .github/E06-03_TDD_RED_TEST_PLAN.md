...
| `float_scores.yml` | T18 | スコアが浮動小数点数 |
...
2. プロンプトファイルを作成
3. テストを実行してRed状態を確認
4. 次のチャットでREDテスト実装が完了したことを報告して https://github.com/Yadon987/aruaruarena/issues/33
